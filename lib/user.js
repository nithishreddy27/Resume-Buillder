...
export async function addDetails(b){  
  ...
  const fname = b.firstName.charAt(0).toUpperCase() + b.firstName.slice(1);
  const mname = b.middleName.charAt(0).toUpperCase() + b.middleName.slice(1);
  const lname = b.lastName.charAt(0).toUpperCase() + b.lastName.slice(1);
