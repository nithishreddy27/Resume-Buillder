  ...
  <form onSubmit={onSubmit}  className="bg-white shadow-md rounded-lg px-12 pt-20 pb-12 mb-4">
   <h1 className="text-center font-bold text-2xl">Sign up to your account</h1>
    ...
    <div className="">
      ...
      <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline focus:border-orange-400 focus:border-2" id="rpassword" name="rpassword" type="password"/>
    </div>
