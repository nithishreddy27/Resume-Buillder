...
<div className="hidden lg:block h-screen bg-gradient-to-b from-slate-700 to-slate-800  w-[100%] overflow-y-scroll scrollbar scrollbar-thumb-orange-800">
        ...
        <div className="container w-[210mm] h-[285mm] bg-white min-w-[210mm] ">
          <div className="grid bg-green-400 grid-cols-11">
            <div className="col-span-8">
              <div className=" bg-cyan-200 p-1 px-1 flex h-52">
                ...
                <div>
                  <div className="text-3xl font-bold p-2 mt-5 tracking-wider">RICHITHA REDDY </div>
                  {/* {details.personal.firstName} {details.personal.lastName}</h1> */}
                  <h1 className="m-1 mt-0 ml-2 text-xl font-bold font-serif  tracking-widest text-cyan-900">{details.personal.role}</h1>
              ...
              {details.work.length != 0 && (
              <div>
                <h1 className="font-medium tracking-wide mt-3 bg-blue-100 mr-60 font-serif text-xl rounded-r-2xl  ml-5 pt-4 mb-1 p-2">INTERNSHIP</h1>
                  {
                    details.work.map(item=>(
              ...
              {details.certifications.length != 0 && (
              <div>
                <h1 className="font-medium tracking-wide mt-3 bg-blue-100 mr-60 font-serif text-xl rounded-r-2xl  ml-5 pt-4 mb-1 p-2">CERTIFICATION</h1>
                {
                details.certifications.map(item=>(
                  <div key={item.title}>
