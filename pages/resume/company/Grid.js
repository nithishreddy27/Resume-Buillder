...
<<<<<<< HEAD
                <div className="bg-slate-50 w-[210mm] scale-[0.4] sm:scale-[0.7] md:scale-[0.9] md:mt-[-50px] sm:mt-[-100px] mx-[-210px] mt-[-250px] h-[285mm] min-w-[210mm] object-cover overflow-auto drop-shadow-2xl flex flex-row">
                  <div className="bg-blue-300 w-[210mm] h-[285mm] p-3">
                    <div className="m-4 mt-10 mb-5  ">
                      <div className="flex ml-4 mr-4 space-x-3 ">
                        <div className="w-[35%] bg-white rounded-md p-3 ">
                          {/* personal details */}
                          <div>
                            <div>
                              <img
                                className="w-[85%] h-[30] p-1 pl-7 ml-2  pb-2 bg- rounded-lg"
                              ...
                              {/* <p className="text-sm">{details.personal.dob}</p> */}

                              {/* <p className="text-sm">{details.personal.email}</p> */}
                              <div>
                                <div className=" pb-2 flex bg-gray-200 rounded-full">
                                  {details.social.map((item) => (
                                    <div
                                      className="mx-3 mt-2  justify-around"
                                      key={item.network}
                                    >
                                      <span>
                                        <Link href={`${item.url}`}>
                        ...
                        <div className="bg-white w-[65%]  rounded-md p-3 ">
                          ...
                          <div>
                            ...
                            {details.awards.map((item) => (
                              <div className="text-sm p-1" key={item.name}>
                    ...
                    <div className="flex space-x-3 m-4 ">
                      <div className="w-[55%] rounded-md ml-4 mr-1 bg-white p-2">
                        <p className="font-bold  m-2 tracking-wide ">
                          EDUCATION
                        </p>
                      ...
                      <div className="bg-white w-[40%] rounded-md p-3 pr-1 ">
                ...
                <div className="flex justify-center ">
                  ...
                  <div className="bg-slate-50 w-[210mm] scale-[0.4] sm:scale-[0.7] md:scale-[0.9] md:mt-[-50px] lg:scale-[0.8] lg:mt-[-80px] xl:scale-[0.9] xl:mt-[-10px] sm:mt-[-100px] mx-[-210px] mt-[-250px] h-[285mm] min-w-[210mm] object-cover overflow-auto drop-shadow-2xl flex flex-row">
                    <div className="bg-blue-300 w-[210mm] h-[285mm] p-3">
                      ...
                      <div className="flex space-x-3 m-4 ">
                        <div className="bg-white w-[40%] rounded-md ml-4 p-2">
                          <p className="font-bold tracking-wide m-2">
                            PROJECTS
                          </p>
                          {details.projects.map((item) => (
                            <div className="p-1" key={item.name}>
