          ...
          <div className="grid grid-cols-1  gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 mt-5">
            ...
            })}
            {
              ...
              l.map((data) => (
                ...
                >
                  <div
                    className="rounded-md bg-gray-100 h-auto  w-63 p-5 m-5 cursor-pointer relative"
                    onClick={() => {
                      setrolepop(true);
                    }}
                  >
          ...
          {rolepop == true && (
            <div className="fixed top-[40%] left-[25%] right-[30%] w-full max-w-2xl">
              <div className=" bg-slate-700 rounded-md ">
                <div className="flex">
                  <h1 className="text-2xl text-white font-medium px-5 py-5 grow">
                    Create Resume
                  </h1>
                  <div
                ...
                <div className="flex">
                  ...
                  <div className="text-xs pt-2 pl-1 text-white">
                    Import resume data from your public resume
                  </div>
                </div>
                <div className="flex justify-end gap-3 pr-5 pb-8">
                  <button
                    className="px-3 py-2 rounded-md bg-white text-gray-700 border border-gray-300"
                    onClick={() => {
                      setrolepop(false);
                    }}
                  >
