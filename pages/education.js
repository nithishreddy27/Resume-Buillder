      ...
      <div className="min-h-screen flex flex-col justify-center items-center pb-4 sm:px-6 lg:px-8">
        <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-3xl relative grid h-screen place-items-center px-2">
          <div className="bg-white pt-1 pb-8 shadow-xl rounded-xl px-10 ">
            <form method="POST" action="./api/addDetails">
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <div className="relative -top-5 left-0">
                    ...
                    >
                      ...
                      <option value="Class Xll">Class Xll</option>
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <div className="relative -top-5 left-0">
                    ...
                    >
                      ...
                      <option value="Electronics and Intrumentation Engineering">Electronics and Intrumentation Engineering</option>
                      <option value="Mechanical Engineering">Mechanical Engineering</option>
                      <option value="Mining Engineering">Mining Engineering</option>
                      <option value="Information Technology">Information Technology</option>
                      <option value="Intrumentation and Control"> Intrumentation and Control</option>
              ...
              <div class="mt-4"><button class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 ">Submit</button></div>
            </form>
          </div>
        </div>
      </div>
