                ...
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    {collegeId == "false" && (
                      <div className="mt-4">
                        <button
                          className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-400  cursor-not-allowed"
                          type="submit"
                        >
                          {" "}
                          Submit{" "}
